...
Current workspace: {}. \
Use fs_list to discover the workspace tree, file_search to find exact text with regular expressions, file_glob to find files by name pattern, and file_read to read exact files or line ranges. \
